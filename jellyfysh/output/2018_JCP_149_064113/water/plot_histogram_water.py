...
def main():
    ...
    reference_plot += plotting_functions.plot_curve(axes, 'ReferenceOOSeparation.dat', r"1",
    ...
    plotting_functions.add_legend(axes, data_plots, bbox_to_anchor=(1.04, 0.77), loc='upper left',
