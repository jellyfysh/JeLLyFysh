...
class BoundaryPointEstimator(Estimator):
    """
    Estimator which compares the space derivatives along the direction of one of the cartesian axes for separations on
    ...
    This methods works only well, when the potential derivative is monotonic.
    """
