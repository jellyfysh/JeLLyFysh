...
#
"""Module for the OutsideFirstLifting class."""
import logging
...
class OutsideFirstLifting(Lifting):
    """
    This class implements the outside-first lifting scheme.
    """

    def __init__(self) -> None:
        """The constructor of the OutsideFirstLifting class."""
    ...
    def get_active_identifier(self) -> Any:
        ...
        self._random_position = sum(self._negative_lifting_rates) - self._random_position
