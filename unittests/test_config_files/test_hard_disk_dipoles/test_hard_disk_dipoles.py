...
class TestHardDiskDipoles(unittest.TestCase):
    def setUp(self) -> None:
        self._config = ConfigParser()
        self._ini_file = resource_filename(
            "jellyfysh", "config_files/hard_disk_dipoles/hard_disk_dipoles.ini")
        ...
        # Replace output file
        self._config.set("PolarizationOutputHandler", "filename", "TestHardDiskDipoles.dat")
    ...
    def tearDown(self) -> None:
        if "TestHardDiskDipoles.dat" in os.listdir("."):
            os.remove("TestHardDiskDipoles.dat")
        if "TestHardDiskDipoles.dat.tmp" in os.listdir("."):
            os.remove("TestHardDiskDipoles.dat.tmp")
        # Reset setting
        setting.reset()
    ...
    def test_run_power_bounded(self, set_up_logging_mock, read_config_mock):
        ...
        try:
            ...
            raise SkipTest(
                "Skip unittests for hard-disk dipoles configuration file because MDAnalysis is not installed.")
        ...
        self.assertIn("TestHardDiskDipoles.dat", os.listdir("."))
