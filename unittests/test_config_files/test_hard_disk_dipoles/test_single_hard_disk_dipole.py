...
class TestSingleHardDiskDipole(unittest.TestCase):
    def setUp(self) -> None:
        self._config = ConfigParser()
        self._ini_file = resource_filename(
            "jellyfysh", "config_files/hard_disk_dipoles/single_hard_disk_dipole.ini")
        ...
        # Replace output file
        self._config.set("PolarizationOutputHandler", "filename", "TestSingleHardDiskDipole.dat")
    ...
    def tearDown(self) -> None:
        if "TestSingleHardDiskDipole.dat" in os.listdir("."):
            os.remove("TestSingleHardDiskDipole.dat")
        if "TestSingleHardDiskDipole.dat.tmp" in os.listdir("."):
            os.remove("TestSingleHardDiskDipole.dat.tmp")
        # Reset setting
        setting.reset()
