...
class TestCellBounded(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._ini_file = "config_files/2018_JCP_149_064113/coulomb_atoms/cell_bounded.ini"
    ...
    def tearDown(self) -> None:
        ...
        if "TestCellBounded.dat" in os.listdir("."):
            os.remove("TestCellBounded.dat")
        if "TestCellBounded.dat.tmp" in os.listdir("."):
            os.remove("TestCellBounded.dat.tmp")
        # Reset setting
        setting.reset()
    ...
    def test_run_cell_bounded(self, read_config_mock):
        ...
        self.assertIn("TestCellBounded.dat", os.listdir("."))
