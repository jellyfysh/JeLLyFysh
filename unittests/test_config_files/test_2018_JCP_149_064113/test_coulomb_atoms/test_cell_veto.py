...
class TestCellVeto(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._ini_file = "config_files/2018_JCP_149_064113/coulomb_atoms/cell_veto.ini"
    ...
    def tearDown(self) -> None:
        ...
        if "TestCellVeto.dat" in os.listdir("."):
            os.remove("TestCellVeto.dat")
        if "TestCellVeto.dat.tmp" in os.listdir("."):
            os.remove("TestCellVeto.dat.tmp")
        # Reset setting
        setting.reset()
    ...
    def test_run_cell_veto(self, read_config_mock):
        ...
        self.assertIn("TestCellVeto.dat", os.listdir("."))
