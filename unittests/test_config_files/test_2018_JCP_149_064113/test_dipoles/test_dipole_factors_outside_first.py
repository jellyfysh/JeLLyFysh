...
class TestDipoleFactorsOutsideFirst(unittest.TestCase):
    def setUp(self) -> None:
        self._config = ConfigParser()
        self._ini_file = "config_files/2018_JCP_149_064113/dipoles/dipole_factors_outside_first.ini"
        ...
        # Replace output file
        self._config.set("SeparationOutputHandler", "filename", "TestDipoleFactorsOutsideFirst.dat")

    def tearDown(self) -> None:
        # Use class method to make sure files are deleted even when a test fails
        if "TestDipoleFactorsOutsideFirst_13.dat" in os.listdir("."):
            os.remove("TestDipoleFactorsOutsideFirst_13.dat")
        if "TestDipoleFactorsOutsideFirst_14.dat" in os.listdir("."):
            os.remove("TestDipoleFactorsOutsideFirst_14.dat")
        if "TestDipoleFactorsOutsideFirst_13.dat.tmp" in os.listdir("."):
            os.remove("TestDipoleFactorsOutsideFirst_13.dat.tmp")
        if "TestDipoleFactorsOutsideFirst_14.dat.tmp" in os.listdir("."):
            os.remove("TestDipoleFactorsOutsideFirst_14.dat.tmp")
        # Reset setting
        setting.reset()
