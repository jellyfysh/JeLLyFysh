...
class TestCellVeto(unittest.TestCase):
    def setUp(self) -> None:
        self._config = ConfigParser()
        self._ini_file = "config_files/2018_JCP_149_064113/dipoles/cell_veto.ini"
        ...
        # Replace output file
        self._config.set("SeparationOutputHandler", "filename", "TestCellVeto.dat")

    def tearDown(self) -> None:
        # Use class method to make sure files are deleted even when a test fails
        if "TestCellVeto_13.dat" in os.listdir("."):
            os.remove("TestCellVeto_13.dat")
        if "TestCellVeto_14.dat" in os.listdir("."):
            os.remove("TestCellVeto_14.dat")
        if "TestCellVeto_13.dat.tmp" in os.listdir("."):
            os.remove("TestCellVeto_13.dat.tmp")
        if "TestCellVeto_14.dat.tmp" in os.listdir("."):
            os.remove("TestCellVeto_14.dat.tmp")
        # Reset setting
        setting.reset()
    ...
    def test_run_cell_veto(self, read_config_mock):
        argv = [self._ini_file]
        ...
        self.assertIn("TestCellVeto_13.dat", os.listdir("."))
        self.assertIn("TestCellVeto_14.dat", os.listdir("."))
