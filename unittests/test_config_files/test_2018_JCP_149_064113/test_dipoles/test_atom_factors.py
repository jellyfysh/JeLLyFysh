...
class TestAtomFactors(unittest.TestCase):
    def setUp(self) -> None:
        self._config = ConfigParser()
        self._ini_file = "config_files/2018_JCP_149_064113/dipoles/atom_factors.ini"
        ...
        # Replace output file
        self._config.set("SeparationOutputHandler", "filename", "TestAtomFactors.dat")

    def tearDown(self) -> None:
        # Use class method to make sure files are deleted even when a test fails
        if "TestAtomFactors_13.dat" in os.listdir("."):
            os.remove("TestAtomFactors_13.dat")
        if "TestAtomFactors_14.dat" in os.listdir("."):
            os.remove("TestAtomFactors_14.dat")
        if "TestAtomFactors_13.dat.tmp" in os.listdir("."):
            os.remove("TestAtomFactors_13.dat.tmp")
        if "TestAtomFactors_14.dat.tmp" in os.listdir("."):
            os.remove("TestAtomFactors_14.dat.tmp")
        # Reset setting
        setting.reset()
    ...
    def test_run_atom_factors(self, read_config_mock):
        argv = [self._ini_file]
        ...
        self.assertIn("TestAtomFactors_13.dat", os.listdir("."))
        self.assertIn("TestAtomFactors_14.dat", os.listdir("."))
