...
class TestDipoleFactorsRatio(unittest.TestCase):
    def setUp(self) -> None:
        self._config = ConfigParser()
        self._ini_file = "config_files/2018_JCP_149_064113/dipoles/dipole_factors_ratio.ini"
        ...
        # Replace output file
        self._config.set("SeparationOutputHandler", "filename", "TestDipoleFactorsRatio.dat")

    def tearDown(self) -> None:
        # Use class method to make sure files are deleted even when a test fails
        if "TestDipoleFactorsRatio_13.dat" in os.listdir("."):
            os.remove("TestDipoleFactorsRatio_13.dat")
        if "TestDipoleFactorsRatio_14.dat" in os.listdir("."):
            os.remove("TestDipoleFactorsRatio_14.dat")
        if "TestDipoleFactorsRatio_13.dat.tmp" in os.listdir("."):
            os.remove("TestDipoleFactorsRatio_13.dat.tmp")
    ...
    def test_run_dipole_factors_ratio(self, read_config_mock):
        argv = [self._ini_file]
        ...
        self.assertIn("TestDipoleFactorsRatio_13.dat", os.listdir("."))
        self.assertIn("TestDipoleFactorsRatio_14.dat", os.listdir("."))
