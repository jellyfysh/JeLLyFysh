...
class TestDipoleMotion(unittest.TestCase):
    def setUp(self) -> None:
        self._config = ConfigParser()
        self._ini_file = "config_files/2018_JCP_149_064113/dipoles/dipole_motion.ini"
        ...
        # Replace output file
        self._config.set("SeparationOutputHandler", "filename", "TestDipoleMotion.dat")

    def tearDown(self) -> None:
        # Use class method to make sure files are deleted even when a test fails
        if "TestDipoleMotion_13.dat" in os.listdir("."):
            os.remove("TestDipoleMotion_13.dat")
        if "TestDipoleMotion_14.dat" in os.listdir("."):
            os.remove("TestDipoleMotion_14.dat")
        if "TestDipoleMotion_13.dat.tmp" in os.listdir("."):
            os.remove("TestDipoleMotion_13.dat.tmp")
        if "TestDipoleMotion_14.dat.tmp" in os.listdir("."):
            os.remove("TestDipoleMotion_14.dat.tmp")
        # Reset setting
        setting.reset()
    ...
    def test_run_dipole_motion(self, read_config_mock):
        argv = [self._ini_file]
        ...
        self.assertIn("TestDipoleMotion_13.dat", os.listdir("."))
        self.assertIn("TestDipoleMotion_14.dat", os.listdir("."))
