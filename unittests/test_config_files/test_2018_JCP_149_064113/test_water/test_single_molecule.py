...
class TestSingleMolecule(unittest.TestCase):
    def setUp(self) -> None:
        self._config = ConfigParser()
        self._ini_file = "config_files/2018_JCP_149_064113/water/single_molecule.ini"
        ...
        # Replace output file
        self._config.set("BondLengthAndAngleOutputHandler", "filename",
                         "TestSingleMolecule.dat")
