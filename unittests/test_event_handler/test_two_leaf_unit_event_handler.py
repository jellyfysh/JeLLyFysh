...
from event_handler.two_leaf_unit_event_handler import TwoLeafUnitEventHandler
from potential import InvertiblePotential
import setting


@mock.patch("event_handler.two_leaf_unit_event_handler.random.expovariate")
class TestTwoLeafUnitEventHandler(TestCase):
    def setUp(self) -> None:
    ...
    def test_send_event_time_without_charge(self, random_expovariate_mock):
        ...
        self._potential_mock_without_charge.displacement.assert_called_once_with(
    ...
    def test_send_event_time_with_charge(self, random_expovariate_mock):
        ...
        # Should be called with beta
        random_expovariate_mock.assert_called_once_with(1)
        self._potential_mock_with_charge.displacement.assert_called_once_with(
