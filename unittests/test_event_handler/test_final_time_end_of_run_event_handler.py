...
from jellyfysh.event_handler.final_time_end_of_run_event_handler import FinalTimeEndOfRunEventHandler
...
class TestFinalTimeEndOfRunEventHandler(ExpandedTestCase, TestCase):
    def setUp(self) -> None:
    ...
    def test_send_out_state_event_handler_one_general_velocity(self):
        ...
        active_cnode_two = Node(Unit(identifier=(3,), position=[0.1, 0.2, 0.3],
        ...
        self.assertAlmostEqualSequence(second_active_cnode.value.position, [0.8, 0.02, 0.15], places=13)
    ...
    def test_end_of_run_time_smaller_than_zero_raises_error(self):
        with self.assertRaises(ConfigurationError):
            FinalTimeEndOfRunEventHandler(end_of_run_time=-1.0, output_handler="output")
